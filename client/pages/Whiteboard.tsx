  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <div className="flex-1 flex gap-4 p-4 overflow-hidden">
        ...
        <div className="w-64 bg-slate-900/50 backdrop-blur border border-slate-700/50 rounded-lg p-4 overflow-y-auto overflow-x-visible flex flex-col gap-4" style={{ overflowYAxis: 'auto' }}>
